...
<head>
    ...
    <title>Audio Conferencing Cordova App (iOS+Android) using RTCMultiConnection</title>
...
<body>
    <article>
        <header style="text-align: center;">
            <h1>
                Audio Conferencing Cordova App (iOS+Android)
            </h1>
            <p class="skip-links">
        ...
        <blockquote class="skip-links">
          Live Demo: <a id="demo" href="https://rtcmulticonnection.herokuapp.com/demos/Audio-Conferencing.html">demos/Audio-Conferencing.html</a>
        </blockquote>
        ...
        <section class="experiment">
            ...
            <ol>
              ...
              <li><a id="Install-Android-App.apk" href="Install-Android-App.apk">Install-Android-App.apk</a></li>
            </ol>
        </section>
